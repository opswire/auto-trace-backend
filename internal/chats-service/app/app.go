...
import (
	...
	"car-sell-buy-system/internal/chats-service/controller/http"
	"car-sell-buy-system/internal/chats-service/domain/chat"
	chatpsql "car-sell-buy-system/internal/chats-service/repository/psql/chat"
...
func Run(cfg *config.Config) {
	...
	handler := gin.New()
	http.NewRouter(handler, l, cfg, chatService)
