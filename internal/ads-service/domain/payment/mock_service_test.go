...
import (
	payment "car-sell-buy-system/internal/ads-service/domain/payment"
	tariff "car-sell-buy-system/internal/ads-service/domain/tariff"
	context "context"
	reflect "reflect"
...
func (mr *MockTariffRepositoryMockRecorder) GetById(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetById", reflect.TypeOf((*MockTariffRepository)(nil).GetById), ctx, id)
}
